            ...
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item">
                            <a href="<%=request.getContextPath()%>/list1" class="nav__link">Trainer List</a>
                        </li>
                        </div>
                    </ul>
                </div>
             ...
             <div class="home__container container grid">
                    <div class="home__data">
                        ...
                        <p class="home__description">
                            List of registered trainer of SASGYM
                        </p>
                        <a href="<%=request.getContextPath()%>/new" class="button button__flex">
                            Add New Trainer <i class="ri-arrow-right-line"></i>
                        </a>
                    </div>
                  </div>
                    ...
                    <tbody>
                        <c:forEach var="trainer" items="${listTrainer}">
                            <tr>
                                ...
                                <td><a href="edit?id=<c:out value='${trainer.id}'/>">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="delete?id=<c:out value='${trainer.id}'/>">Delete</a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
